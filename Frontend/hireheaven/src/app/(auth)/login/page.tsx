                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="border border-gray-400 rounded-2xl p-8 shadow-lg backdrop-blur-sm">
                        <form onSubmit={submitHandler} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="password" className="text-sm font-medium">Email Address</Label>
                                <div className="relative">
                            ...
                            <Button disabled={btnLoading} className='w-full'>{btnLoading ? "Signing in..." : "Sign In"}
                                <ArrowRight size={18} />
                            </Button>

                        </form>
                        <div className="mt-6 pt-6 border-t border-gray-400 ">
                            <p className='text-center text-sm'>Don't have an account? <Link href={"/register"} className='text-sm text-blue-500 hover:underline transition-all font-medium'>Create a new account</Link></p>
                        </div>
                    </div>
                </div>
            </div>
