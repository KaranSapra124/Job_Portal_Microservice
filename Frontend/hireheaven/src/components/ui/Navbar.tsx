    ...
    return (
        <nav className='z-50 sticky top-0 bg-background/80 border-b backdrop-blur-md shadow-sm'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className="flex justify-between h-18 items-center lg:px-8">
                                    ...
                                    <PopoverTrigger asChild>
                                        <button className='flex items-center hover:opacity-80 transition-opacity gap-2'>
                                            <Avatar className='h-9 w-9 ring-2 ring-offset-2 ring-offset-background ring-blue-500/20 cursor-pointer hover:ring-blu-500/40 transition-all'>
                                                ...
                                                <AvatarFallback className='bg-blue-100 dark"bg-blue-900 text-blue-600'>{user?.name?.charAt(0)}</AvatarFallback>
                                            </Avatar>
                                        </button>
                                    </PopoverTrigger>
            ...
            {/* Mobile View */}
            <div className={`md:hidden border-t overflow-hiddenn transition-all duration-300 ease-in-out ${isOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
                        ...
                        isAuth ?
                            <>
                                ...
                                <Link href={"/login"} onClick={toggleMenu}>
                                    <Button className='w-full justify-start gap-3 mt-2 h-11'>
